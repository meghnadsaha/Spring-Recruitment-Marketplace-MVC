  ...
  <div class="container" >
	...
	<%
		...
		if(post != null)
		{
			...
			%>
		      <div class="filter">
		        <div class="col-md-7  pagi_summary"><span><%= post.getJobCode()%> ( <%= post.getTitle() %> - <%= post.getLocation() %> )</span>
		       
		         <audio controls>
  <source src="horse.ogg" type="audio/ogg">
  <source src="G:\var\unihyr\data\<%=post.getUploadjdaudio() %>" type="audio/mpeg">
</audio>  
		        </div>
		        ...
		        <div class="col-md-5">
		          ...
		          <ul class="page_nav">
		            <%
		            	...
		            	{ 
		            		%>
		            			<li class="active" ><a href="clientpostapplicants?pid=<%=post.getPostId()%>"><%=GeneralConfig.Label_ForConsManagePosition %></a></li> 
		            		<%
		            	}
			           /*  if(post.getDeleteDate() == null)
		            	{ */
