...
if(((String)currentpage).equals("clientapplicants")&&arcflag!=null){
	flaga=true;
}else if(((String)currentpage).equals("clientapplicants")&&arcflag==null){
	flag=true;
}

%>
	       
	        <li class="<%= flag? "active" : ""%>"><a href="clientpostapplicants">Manage Positions </a></li>
...
<%-- 			<li class='<%= flaga? "active" : ""%>' ><a href="clientpostapplicants?arcflag=true">Archive</a></li> --%>
