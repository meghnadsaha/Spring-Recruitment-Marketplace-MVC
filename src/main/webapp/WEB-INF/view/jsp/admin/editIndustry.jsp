      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Update Industry</li>
          </ol>
        </section>
				...
				<div class="col-md-6">  
				  <div class="box box-success" style="min-height: 200px">
		           <div class="box-header with-border bg-green">
		             <h3 class="box-title">Add Update Industry</h3>
		           ...
		           <div class="box-body no-padding">
	           		 <form:form method="POST"  class="form-horizontal" action="admineditindustry" commandName="indForm" onsubmit=" return validateForm()">
		                  <div class="box-body">
		                  		<div class="form-group">
			                      <label class="col-sm-4 control-label" for="inputEmail3">Industry</label>
			                      <div class="col-sm-8">
			                        <form:input path="industry" class="form-control" />
			                        <span class="error"> ${ind_error}</span>
			                        <form:hidden path="id"/>
			                      </div>
			                    </div>
