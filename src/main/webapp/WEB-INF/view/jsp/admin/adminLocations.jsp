				  ...
				  <div class="box box-success" style="min-height: 200px">
		           <div class="box-header with-border bg-green">
		             ...
		             <div class="box-tools pull-right">
		               <a href="adminaddlocation" class="btn text-white" style="color: #fff;">New Location</a>
		             </div>
		           </div>
		           <!-- /.box-header -->
		   	           		 	...
		   	           		 	if (locList != null && !locList.isEmpty()) 
		   	           		 	{
		   	           		 		for (Location loc : locList) 
		   	           		 		{
											...
											<tr>
												...
												<td><%= DateFormats.getTimeValue(loc.getCreateDate()) %></td>
												<td class="text-center"><a href="admineditlocation?lid=<%= loc.getLid()%>"><button class="btn btn-sm btn-success"> Edit </button></a></td>
											</tr>
		       		 					<%
			           		 		}
			           		 	}
