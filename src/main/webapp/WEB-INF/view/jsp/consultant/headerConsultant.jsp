    ...
    <div class="container">
		...
		<nav class="nav">
				...
				<ul class="toggle_menu">
					...
					<li class="${currentpage == 'consnewposts' ? 'active' : ''}" class="active"><a href="consnewposts">New Positions<%-- (<%=request.getAttribute("newpostcount") %>) --%></a></li>
					<%
						boolean flag=false;
						boolean flaga=false;
						String arcflag=request.getParameter("arcflag");
						if(((String)currentpage).equals("cons_your_positions")&&arcflag!=null){
							flaga=true;
						}else if(((String)currentpage).equals("cons_your_positions")&&arcflag==null){
							flag=true;
						}
						
					%>
					
					<li class="<%= flag? "active" : ""%>"><a href="cons_your_positions">Manage Positions</a></li>
...
<%-- 					<li class='<%= flaga? "active" : ""%>' ><a href="cons_your_positions?arcflag=true">Archive</a></li> --%>
