...
public interface QualificationDao
{
	...
	/**
	 * to get qualification object by qid
	 * @param qualification id of Qualification to be deleted
	 * @return qualification object if updated successfully, null if not
	 */
	Qualification getQualificationByQid(long qid);
